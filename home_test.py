...
x_audio_path = os.path.join(current_directory,"x_axis.wav")
y_audio_path = os.path.join(current_directory,"y_axis.wav")
z_audio_path = os.path.join(current_directory, "z_axis.wav")
